                ...
                <CardContent className="space-y-4 pt-0">
                  <div className="p-3 rounded-xl bg-muted/40 border space-y-2 text-xs">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-semibold text-primary">{series.registrations.length} Candidates</span>
                    </div>
                    <div className="flex items-center gap-1.5 pt-1.5 border-t text-[11px] text-muted-foreground">
                  ...
                  <div className="flex items-center gap-2 pt-1 border-t">
                    <Button
                      ...
                      variant="outline"
                      className="flex-1 h-8 text-xs font-semibold rounded-xl gap-1 hover:bg-muted"
                    >
                      <Plus className="h-3.5 w-3.5" />
                    ...
                    <Button
                      ...
                      className="flex-1 h-8 text-xs font-semibold rounded-xl bg-primary text-primary-foreground gap-1 hover:bg-primary/90"
                    >
                      <Users className="h-3.5 w-3.5" />
                      <span>Enroll</span>
                    </Button>
                  ...
                  {filteredRegistrations.length === 0 ? (
                    <tr>
                      <td colSpan={6} className="py-12 text-center text-muted-foreground text-xs">
                        No candidate registrations match your criteria.
                      </td>
                    </tr>
                  ) : (
