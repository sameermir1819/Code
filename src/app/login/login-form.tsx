...
export function LoginForm({
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#07090e] text-zinc-100 font-sans selection:bg-indigo-500/25 selection:text-white relative overflow-hidden p-4 sm:p-6">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[650px] h-[520px] bg-gradient-to-tr from-indigo-500/10 via-blue-500/5 to-purple-500/10 rounded-full blur-[140px] pointer-events-none z-0" />
      ...
      <div className="w-full max-w-[420px] relative z-10 space-y-4">
        ...
        <div className="flex items-center justify-between px-1">
          <span className="text-xs text-zinc-400">Enrolled Student?</span>
          <Link
            href="/student-login"
        ...
        {/* ── Auth Card ── */}
        <div className="p-8 sm:p-10 rounded-3xl bg-[#0d121d]/85 backdrop-blur-2xl border border-white/[0.08] shadow-2xl shadow-black/80 space-y-6">
          {/* Brand Header */}
          <div className="text-center space-y-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-zinc-400">
                {tagline || "Administrative Workspace & Operations Sign In"}
              </p>
            </div>
          </div>
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  onClick={() => {
                    setErrorMsg("");
                    setInfoMsg("Please contact your institute's Super Administrator to reset your password.");
                  }}
        ...
        <div className="text-center text-[11px] text-zinc-600">
          <span>&copy; {new Date().getFullYear()} {instituteName}. Authorized personnel only.</span>
        </div>
      </div>
    </div>
  );
