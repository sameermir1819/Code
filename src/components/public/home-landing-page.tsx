      ...
      <header className="sticky top-0 z-50 w-full border-b border-white/[0.08] bg-[#06080f]/85 backdrop-blur-xl transition-all">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between gap-2 sm:gap-4">
          ...
          <div className="hidden sm:flex items-center gap-3 shrink-0">
            <Link
              href="/external-results"
              className="inline-flex items-center gap-1.5 rounded-xl border border-emerald-400/30 bg-emerald-500/10 px-3.5 py-2 text-xs font-bold text-emerald-300 transition-all hover:bg-emerald-500/20 hover:text-emerald-200"
            >
          ...
          <div className="flex sm:hidden items-center gap-1.5 shrink-0">
            <Link
              href="/external-results"
              className="flex items-center gap-1 rounded-lg border border-emerald-400/25 bg-emerald-500/15 px-2 py-1.5 text-[11px] font-bold text-emerald-300 transition-all active:scale-95"
            >
          ...
          <div className="sm:hidden px-4 pt-3 pb-6 border-b border-white/10 bg-[#070a14] space-y-3">
            <div className="flex flex-col space-y-2 text-sm font-medium text-zinc-300">
              <Link
                ...
                className="flex items-center justify-between rounded-xl border border-emerald-400/25 bg-emerald-500/10 px-3 py-2.5 font-bold text-emerald-300"
              >
                <span className="flex items-center gap-2"><Award className="h-4 w-4" /> Check Test Result</span>
      ...
      <section id="test-series" className="relative z-10 py-16 sm:py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-white/5">
        <div className="text-center max-w-3xl mx-auto space-y-2 mb-12">
          ...
          <div className="pt-4">
            <Link
              href="/external-results"
              className="inline-flex items-center gap-2 rounded-xl bg-emerald-500 px-5 py-2.5 text-sm font-black text-slate-950 shadow-lg shadow-emerald-500/20 transition-all hover:bg-emerald-400 hover:scale-[1.02]"
            >
              <Award className="h-4 w-4" /> External Candidate — Check Result
              <ArrowRight className="h-4 w-4" />
            </Link>
            <p className="mt-2 text-[11px] text-zinc-500">Use the Roll Number and Receipt Number printed on your slip.</p>
          </div>
        </div>
